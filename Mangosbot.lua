...
function CreateBotRoster()
    ...
    for i = 1,10 do
        ...
        CreateToolBar(item, -18, "quickbar"..i, {
            ["login"] = {
                ...
                command = {[0] = ""},
                strategy = "",
                tooltip = "使机器人在线",--"Bring bot online",
                index = 0
            },
            ["logout"] = {
                icon = "logout",
                command = {[0] = ""},
                tooltip = "登出机器人",--"Logout bot",
                strategy = "",
                index = 0
            },
            ["invite"] = {
                icon = "invite",
                command = {[0] = ""},
                tooltip = "邀请加入您的队伍",--"Invite to your group",
                strategy = "",
                index = 1
            },
            ["leave"] = {
                icon = "leave",
                command = {[0] = ""},
                tooltip = "从小组中移除",--"Remove from group",
                strategy = "",
                index = 1
            },
            ["whisper"] = {
                icon = "whisper",
                command = {[0] = ""},
                tooltip = "开始私聊",--"Start whisper chat",
                strategy = "",
                index = 2
            },
            ["summon"] = {
                icon = "summon",
                command = {[0] = ""},
                tooltip = "召见石(将队友召唤到身边)",--"Summon at meeting stone",
                strategy = "",
                index = 3
            }
        }, 20, 0, false)
    ...
    CreateToolBar(frame, 0, "quickbar", {
        ["login_all"] = {
            ...
            command = {[0] = ""},
            strategy = "",
            tooltip = "使所有机器人在线",--"Bring all bots online",
            index = 0
        },
        ["logout_all"] = {
            icon = "logout",
            command = {[0] = ""},
            tooltip = "注销所有机器人",--"Logout all bots",
            strategy = "",
            index = 1
        },
        ["invite_all"] = {
            icon = "invite",
            command = {[0] = ""},
            tooltip = "邀请所有机器人加入您的群组",--"Invite all bots to your group",
            strategy = "",
            index = 2
        },
        ["leave_all"] = {
            icon = "leave",
            command = {[0] = ""},
            tooltip = "从组中删除所有机器人",--"Remove all bots from group",
            strategy = "",
            index = 3
        }
    }, 5, 0, false)
...
function CreateMovementToolBar(frame, y, name, group, x, spacing, register)
    ...
    if (not group) then
        tb["runaway"] = {
            ...
            strategy = "runaway",
            tooltip = "逃离暴徒?围攻?",--"Run away from mobs",
            index = index,
            group = group
        }
        index = index + 1
        tb["guard"] = {
            ...
            strategy = "guard",
            tooltip = "守卫预设地点",--"Guard pre-set place",
            index = index,
            group = group
        }
        index = index + 1
        tb["grind"] = {
            ...
            strategy = "grind",
            tooltip = "挑衅模式(研磨--grinding)",--"Aggresive mode (grinding)",
            index = index,
            group = group
        }
        index = index + 1
    ...
    if (group) then
        tb["loot"] = {
            ...
            strategy = "",
            tooltip = "掠夺一切(拾取)",--"Loot everything",
            index = index,
            group = group
        }
        index = index + 1
        tb["attack"] = {
            ...
            strategy = "",
            tooltip = "攻击我的目标",--"Attack my target",
            index = index,
            group = group
        }
        index = index + 1
...
function CreateFormationToolBar(frame, y, name, group, x, spacing, register)
    return CreateToolBar(frame, -y, name, {
        ...
        ["arrow"] = {
            ...
            formation = "arrow",
            tooltip = "坦克在前，dps在后",--"Tank first, dps last",
            index = 2,
            group = group
        },
        ["far"] = {
            ...
            formation = "far",
            tooltip = "保持距离",--"Maintain a distance",
            index = 3,
            group = group
        },
        ["chaos"] = {
...
function CreateStanceToolBar(frame, y, name, group, x, spacing, register)
    return CreateToolBar(frame, -y, name, {
        ...
        ["turnback"] = {
            ...
            stance = "turnback",
            tooltip = "用坦克把敌人赶出队伍",--"Tank the enemy away from party",
            index = 2,
            group = group
        },
        ["behind"] = {
            ...
            stance = "behind",
            tooltip = "从后面攻击（近战）",--"Attack from behind (melee)",
            index = 3,
            group = group
        }
    }, x, spacing, register)
...
function CreateGenericNonCombatToolBar(frame, y, name, group, x, spacing, register)
    return CreateToolBar(frame, -y, name, {
        ["food"] = {
            ...
            command = {[0] = "nc ~food,?"},
            strategy = "food",
            tooltip = "使用食物和饮料",--"Use food and drinks",
            index = 0,
            group = group
        },
        ["buff"] = {
            ...
            command = {[0] = "nc ~buff,?"},
            strategy = "buff",
            tooltip = "Buff增益队伍成员",--"Buff party members",
            index = 1,
            group = group
        },
        ["loot"] = {
            ...
            command = {[0] = "nc ~loot,?"},
            strategy = "loot",
            tooltip = "允许抢劫(拾取)",--"Enable looting",
            index = 2,
            group = group
        },
        ["gather"] = {
            ...
            command = {[0] = "nc ~gather,?"},
            strategy = "gather",
            tooltip = "采集草药、矿石等。",--"Gather herbs, ore, etc.",
            index = 3,
            group = group
        }
    }, x, spacing, register)
...
function CreateGenericCombatToolBar(frame, y, name, group, x, spacing, register)
    return CreateToolBar(frame, -y, name, {
        ["potions"] = {
            ...
            strategy = "potions",
            tooltip = "使用生命和法力药剂",--"Use health and mana potions",
            index = 0,
            group = group
        },
        ["cast_time"] = {
            ...
            strategy = "cast time",
            tooltip = "不要对几乎死亡的目标施放长法术",--"Do not cast long spells on almost dead targets",
            index = 1,
            group = group
        },
        ["mark_rti"] = {
            ...
            strategy = "mark rti",
            tooltip = "用raid图标标记当前目标",--"Mark current target with raid icon",
            index = 2,
            group = group
        },
        ["ads"] = {
            ...
            strategy = "ads",
            tooltip = "如果ads可能被撤销，请逃离",--"Flee if ads might be pulled",
            index = 3,
            group = group
        },
        ["boost"] = {
            ...
            command = {[0] = "co ~boost,?"},
            strategy = "boost",
            tooltip = "通过冷却提高dps",--"Boost dps by using cooldowns",
            index = 4,
            group = group
        },
        ["conserve_mana"] = {
            ...
            tooltip = "以DPS为代价减少法力消耗",--"Reduce mana usage at cost of DPS",
            index = 5,
            group = group
        },
        ["cc"] = {
            ...
            command = {[0] = "co ~cc,?"},
            strategy = "cc",
            tooltip = "使用人群控制能力",--"Use crowd control abilities",
            index = 6,
            group = group
        }
    }, x, spacing, register)
...
function CreateSaveManaToolBar(frame, y, name, group, x, spacing, register)
    ...
    for i = 1, 5 do
        buttons["savemana"..i] = {
            ...
            tooltip = "保存法力等级: "..(i>1 and "#"..i or "禁用"),--"Save mana level: "..(i>1 and "#"..i or "disabled"),
            index = i - 1,
            group = group,
            savemana = i
        }
...
function CreateSelectedBotPanel()
    ...
    CreateToolBar(frame, -y, "actions", {
        ["stats"] = {
            ...
            command = {[0] = "stats"},
            strategy = "",
            tooltip = "告诉统计数据（XP、金钱等）",--"Tell stats (XP, money, etc.)",
            index = 0
        },
        ["whisper"] = {
            icon = "whisper",
        ...
        ["set_guard"] = {
            ...
            strategy = "",
            tooltip = "设置警卫位置",--"Set guard position",
            index = 3
        },
        ["release"] = {
            icon = "release",
        ...
        ["revive"] = {
            ...
            command = {[0] = "revive"},
            strategy = "",
            tooltip = "在灵魂治疗师复活",--"Revive at Spirit Healer",
            index = 5
        }
    })
    ...
    CreateToolBar(frame, -y, "inventory", {
        ["los"] = {
            ...
            command = {[0] = "los gos"},
            strategy = "",
            tooltip = "显示附近的游戏对象",--"Show nearby game objects",
            index = 0
        },
        ["count"] = {
            icon = "count",
        ...
        ["spells"] = {
            ...
            command = {[0] = "spells +"},
            strategy = "",
            tooltip = "显示贸易技能",--"Show tradeskill",
            index = 3
        },
        ["mail"] = {
            icon = "mail",
    ...
    CreateToolBar(frame, -y, "loot", {
        ["ll_normal"] = {
            ...
            command = {[0] = "ll normal"},
            loot = "normal",
            tooltip = "仅掠夺(拾取)贸易技能物品",--"Loot tradeskill items only",
            index = 0
        },
        ["ll_gray"] = {
            icon = "ll_gray",
            command = {[0] = "ll gray"},
            loot = "gray",
            tooltip = "掠夺(拾取)灰色物品",--"Loot gray items",
            index = 1
        },
        ["ll_disenchant"] = {
            icon = "ll_disenchant",
            ...
            loot = "disenchant",
            tooltip = "掠夺(拾取) BoE(装备绑定) 物品以进行分解",--"Loot BoE items for disenchanting",
            index = 2
        },
        ["ll_all"] = {
            icon = "ll_all",
            command = {[0] = "ll all"},
            loot = "all",
            tooltip = "掠夺(拾取)一切",--"Loot everything",
            index = 3
        }
    })
    ...
    CreateToolBar(frame, -y, "attack_type", {
        ...
        ["threat"] = {
            ...
            command = {[0] = "co ~threat,?"},
            strategy = "threat",
            tooltip = "保持低威胁级别",--"Keep threat level low",
            index = 4
        }
    })
    ...
    CreateToolBar(frame, -y, "CLASS_DRUID", {
        ...
        ["caster"] = {
            ...
            command = {[0] = "co +caster,?"},
            strategy = "caster",
            tooltip = "使用脚轮(法师)形式",--"Use caster form",60数据库查到一个 黑暗法师 Dark Caster 模型是一个骷髅
            index = 2
        },
        ["heal"] = {
            icon = "heal",
        ...
        ["cure"] = {
            ...
            strategy = "cure",
            tooltip = "治愈（毒药、疾病等）",--"Cure (poison, disease, etc.)",
            index = 4
        },
        ["melee"] = {
            icon = "dps",
    ...
    CreateToolBar(frame, -y, "CLASS_HUNTER", {
        ...
        ["aoe"] = {
            ...
            command = {[0] = "co ~aoe,?"},
            strategy = "aoe",
            tooltip = "使用AOE技能",--"Use AOE abilities",
            index = 1
        },
        ["bspeed"] = {
            icon = "bspeed",
            ...
            strategy = "bspeed",
            tooltip = "Buff增益移动速度",--"Buff movement speed",
            index = 2
        },
        ["bdps"] = {
            icon = "bdps",
    ...
    CreateToolBar(frame, -y, "CLASS_MAGE", {
        ["arcane"] = {
            ...
            command = {[0] = "co +arcane,?"},
            strategy = "arcane",
            tooltip = "使用奥术",--"Use arcane spells",
            index = 0
        },
        ["fire"] = {
            icon = "fire",
        ...
        ["fire_aoe"] = {
            ...
            strategy = "fire aoe",
            tooltip = "使用火焰AOE技能",--"Use fire AOE abilities",
            index = 2
        },
        ["frost"] = {
            icon = "frost",
            command = {[0] = "co +frost,?"},
            strategy = "frost",
            tooltip = "使用冰霜法术",--"Use frost spells",
            index = 3
        },
        ["frost_aoe"] = {
            icon = "frost_aoe",
            ...
            strategy = "frost aoe",
            tooltip = "使用冰霜AOE技能",--"Use frost AOE abilities",
            index = 4
        },
        ["bmana"] = {
            icon = "bmana",
            ...
            strategy = "bmana",
            tooltip = "Buff增益法力回复",--"Buff mana regen",
            index = 5
        },
        ["bdps"] = {
            icon = "bdps",
    ...
    CreateToolBar(frame, -y, "CLASS_PALADIN", {
        ...
        ["bthreat"] = {
            ...
            strategy = "bthreat",
            tooltip = "增加威胁生成",--"Increase threat generation",
            index = 4
        }
    })
    CreateToolBar(frame, -y, "CLASS_PRIEST", {
        ...
        ["holy"] = {
            ...
            command = {[0] = "co +holy,?"},
            strategy = "holy",
            tooltip = "使用神圣法术",--"Use holy spells",
            index = 1
        },
        ["shadow"] = {
            icon = "shadow",
            command = {[0] = "co +shadow,?"},
            strategy = "shadow",
            tooltip = "DPS模式：暗影",--"Dps mode: shadow",
            index = 2
        },
        ["shadow_aoe"] = {
            icon = "shadow_aoe",
            ...
            strategy = "shadow aoe",
            tooltip = "使用暗影AOE技能",--"Use shadow AOE abilities",
            index = 3
        },
        ["shadow_debuff"] = {
            icon = "shadow_debuff",
            ...
            tooltip = "使用暗影减益debuff",--"Use shadow debuffs",
            index = 4
        },
        ["cure"] = {
            icon = "cure",
    ...
    CreateToolBar(frame, -y, "CLASS_SHAMAN", {
        ...
        ["caster_aoe"] = {
            ...
            strategy = "caster aoe",
            tooltip = "使用脚轮AOE技能",--"Use caster AOE abilities",
            index = 1
        },
        ["heal"] = {
            icon = "heal",
        ...
        ["melee_aoe"] = {
            ...
            strategy = "melee aoe",
            tooltip = "使用近战AOE技能",--"Use melee AOE abilities",
            index = 4
        },
        ["totems"] = {
            icon = "totems",
    ...
    CreateToolBar(frame, -y, "CLASS_WARLOCK", {
        ...
        ["dps_debuff"] = {
            ...
            strategy = "dps debuff",
            tooltip = "使用 DPS 减益debuff",--"Use DPS debuffs",
            index = 1
        },
        ["caster_aoe"] = {
            icon = "caster_aoe",
        ...
        ["tank"] = {
            ...
            command = {[0] = "co +tank,?"},
            strategy = "tank",
            tooltip = "召唤坦克恶魔",--"Summon tanky demons",
            index = 3
        },
        ["pet"] = {
            icon = "pet",
    ...
    CreateToolBar(frame, -y, "CLASS_PALADIN_BUFF", {
        ["bmana"] = {
            ...
            command = {[0] = "co +bmana,?", [1] = "nc +bmana,?"},
            strategy = "bmana",
            tooltip = "增益法力回复",--"Buff mana regen",
            index = 0
        },
        ["bhealth"] = {
            icon = "bhealth",
            ...
            strategy = "bhealth",
            tooltip = "增益生命恢复",--"Buff health regen",
            index = 1
        },
        ["bdps"] = {
            icon = "bdps",
            command = {[0] = "co +bdps,?", [1] = "nc +bdps,?"},
            strategy = "bdps",
            tooltip = "增益近战DPS",--"Buff melee DPS",
            index = 2
        },
        ["bstats"] = {
            icon = "holy",
    ...
    CreateToolBar(frame, -y, "CLASS_PALADIN_AURA", {
        ...
        ["rfire"] = {
            ...
            strategy = "rfire",
            tooltip = "耐火光环",--"Fire resistance aura",
            index = 1
        },
        ["rfrost"] = {
            icon = "frost",
            ...
            strategy = "rfrost",
            tooltip = "冰霜抗性光环",--"Frost resistance aura",
            index = 2
        },
        ["rshadow"] = {
            icon = "rshadow",
            command = {[0] = "co +rshadow,?", [1] = "nc +rshadow,?"},
            strategy = "rshadow",
            tooltip = "暗影抗性光环",--"Shadow resistance aura",
            index = 3
        },
        ["barmor"] = {
            icon = "barmor",
